...
wrap::Response wrap::httpsreq(wrap::req request) {
	...
	if (wrap::toSource.newsession) {
		...
		wrap::toSource.session_handle = InternetOpenA(wrap::toSource.ua.c_str(), wrap::toSource.AccessType, wrap::toSource.Proxy.url.c_str(), NULL, INTERNET_FLAG_DONT_CACHE | INTERNET_FLAG_PRAGMA_NOCACHE | INTERNET_FLAG_RELOAD);
